...
public class CompanyResourceIntTest {
    ...
    private static final String DEFAULT_HR_EMAIL = "AAAAAAAAAA";
    private static final String UPDATED_HR_EMAIL = "BBBBBBBBBB";
    ...
    public void createCompany() throws Exception {
        ...
        assertThat(testCompany.getHrEmail()).isEqualTo(DEFAULT_HR_EMAIL);
        assertThat(testCompany.getManagerEmail()).isEqualTo(DEFAULT_MANAGER_EMAIL);
    ...
    @Test
    @Transactional
    public void checkHrEmailIsRequired() throws Exception {
        int databaseSizeBeforeTest = companyRepository.findAll().size();
        // set the field null
        company.setHrEmail(null);
    ...
    @Test
    @Transactional
    public void checkManagerEmailIsRequired() throws Exception {
        int databaseSizeBeforeTest = companyRepository.findAll().size();
        // set the field null
        company.setManagerEmail(null);
    ...
    public void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc.perform(get("/api/companies?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].hrEmail").value(hasItem(DEFAULT_HR_EMAIL.toString())))
            .andExpect(jsonPath("$.[*].managerEmail").value(hasItem(DEFAULT_MANAGER_EMAIL.toString())))
    ...
    public void getCompany() throws Exception {
        ...
        restCompanyMockMvc.perform(get("/api/companies/{id}", company.getId()))
            ...
            .andExpect(jsonPath("$.hrEmail").value(DEFAULT_HR_EMAIL.toString()))
            .andExpect(jsonPath("$.managerEmail").value(DEFAULT_MANAGER_EMAIL.toString()))
    ...
    public void updateCompany() throws Exception {
        ...
        assertThat(testCompany.getHrEmail()).isEqualTo(UPDATED_HR_EMAIL);
        assertThat(testCompany.getManagerEmail()).isEqualTo(UPDATED_MANAGER_EMAIL);
