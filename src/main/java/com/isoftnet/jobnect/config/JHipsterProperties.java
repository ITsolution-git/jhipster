package com.isoftnet.jobnect.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "isoftnet@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "isoftnet API";

        private String description = "isoftnet API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "isoftnet";
