(function() {
    ...
    JobRatingDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'JobRating'];

    function JobRatingDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, JobRating) {
        var vm = this;
